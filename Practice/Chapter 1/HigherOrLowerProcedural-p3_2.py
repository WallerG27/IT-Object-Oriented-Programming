...
# play multiple games
    ...
    valid = False
    while valid == False:
        nCards = input('How many cards do you want to play? Enter a number between 1 and '+ str(maxCards) + ': ')
        if nCards.isdigit():
            nCards = int(nCards)
            if 0 < nCards < maxCards:
                valid = True
