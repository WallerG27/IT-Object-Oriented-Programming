...
def find(aName, aPassword):
    global accountsList
    for i in range(len(accountsList)):
        thisAccountDict = accountsList[i]
        if thisAccountDict['name'] == aName and thisAccountDict['password'] == aPassword: 
            return i
    return None
...
while True:
    ...
    print('Press f to find an account number')
    ...
    if action == 'b':
        ...
        print('Find Account:')
        userName = input('Please enter the name on the account: ')
        userPassword = input('Please enter the password: ')
        userAccountNumber = find(userName, userPassword)
        if userAccountNumber is not None:
            print('Your account number is:', userAccountNumber)
        else:
            print('I could not find an account matching the provided name and password.')
